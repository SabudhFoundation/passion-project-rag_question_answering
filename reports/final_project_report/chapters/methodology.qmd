...
*   **Chainlit Integration:** A custom `MongoDataLayer` intercepts application hooks. It automatically saves:
    *   **Conversational steps:** Each user query, rewritten prompt, retrieved document list, and final answer.
    *   **User feedback:** Upvotes and downvotes on specific answers.
    *   **Session states:** Allowing users to resume their conversations after page reloads or server restarts.
